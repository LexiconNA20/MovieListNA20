...
namespace MovieListNA20.TagHelpers
{
    [HtmlTargetElement("star")]
    public class StarTagHelper : TagHelper
    {
        //private MovieListNA20Context db;
        //public StarTagHelper(MovieListNA20Context db)
        //{
        //    this.db = db;
        //}
        ...
        {
            //var m = db.Movie.FirstOrDefault();

            output.TagName = "span";
            output.AddClass("stars", HtmlEncoder.Default);
